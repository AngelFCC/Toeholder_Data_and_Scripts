...
input_seq = '/media/axelle/Angel_backup/iGEM/Toeholds_viruses_Nathan/norovirus_target.fasta'
...
output_folder = '/media/axelle/Angel_backup/iGEM/Toeholds_viruses_Nathan/Norovirus_toeholds_github'
