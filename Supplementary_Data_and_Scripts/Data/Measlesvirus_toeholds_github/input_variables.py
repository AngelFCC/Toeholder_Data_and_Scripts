...
input_seq = '/media/axelle/Angel_backup/iGEM/Toeholds_viruses_Nathan/measlesvirus_target.fasta'
...
output_folder = '/media/axelle/Angel_backup/iGEM/Toeholds_viruses_Nathan/Measlesvirus_toeholds_github'
...
reference_list = '/media/axelle/Angel_backup/iGEM/Genomes/Measles/Genome_list.txt'
